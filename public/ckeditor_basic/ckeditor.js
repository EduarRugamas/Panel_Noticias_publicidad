...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > e.getListenerIndex(d)) {
                    ...
                    l.fn = d;
                    l.priority = g;
                    for (var w = e.length - 1; 0 <= w; w--) if (e[w].priority <= g) return e.splice(w + 1, 0, l), {removeListener: v};
                    e.unshift(l)
                }
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var g = 1; g < b; g++) {
                    ...
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(m), function (b) {
                        if (!0 === c || null == a[b]) if (!e || b in e) a[b] = m[b]
                    })
                }
                return a
            },
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var b, c = [], e = 0; e < a.length; e++) if (b = a[e]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
                return c.join("")
            },
            ...
            transformPlainTextToHtml: function (a, b) {
                var c = b == CKEDITOR.ENTER_BR, e = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    e = e.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), g = b == CKEDITOR.ENTER_P ? "p" : "div";
                if (!c) {
                    var m = /\n{2}/g;
                    if (m.test(e)) var d = "\x3c" + g + "\x3e", l = "\x3c/" + g + "\x3e",
                        e = d + e.replace(m, function () {
                            return l + d
                        }) + l
                }
                e = e.replace(/\n/g, "\x3cbr\x3e");
                c || (e =
                    e.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"), function (a) {
                        return CKEDITOR.tools.repeat(a, 2)
                    }));
                e = e.replace(/^ | $/g, "\x26nbsp;");
                return e = e.replace(/(>|\s) /g, function (a, b) {
                    return b + "\x26nbsp;"
                }).replace(/ (?=<)/g, "\x26nbsp;")
            },
            ...
            setTimeout: function (a, b, c, e, g) {
                ...
                return g.setTimeout(function () {
                    e ? a.apply(c, [].concat(e)) : a.apply(c)
                }, b || 0)
            },
            ...
            indexOf: function (a, b) {
                if ("function" == typeof b) for (var c = 0, e = a.length; c < e; c++) {
                    if (b(a[c])) return c
                } else {
                    if (a.indexOf) return a.indexOf(b);
                    c = 0;
                    for (e = a.length; c < e; c++) if (a[c] === b) return c
                }
                return -1
            },
            search: function (a, b) {
            ...
            normalizeCssText: function (a, b) {
                var c = [], e, g = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            objectCompare: function (a, b, c) {
                ...
                if (!a && !b) return !0;
                if (!a || !b) return !1;
                for (e in a) if (a[e] != b[e]) return !1;
                if (!c) for (e in b) if (a[e] != b[e]) return !1;
                return !0
            },
            ...
            enableHtml5Elements: function (a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), e = c.length, g; e--;) g = a.createElement(c[e]), b && a.appendChild(g)
            },
            checkIfAnyArrayItemMatches: function (a, b) {
                for (var c = 0, e = a.length; c < e; ++c) if (a[c].match(b)) return !0;
                return !1
            },
            ...
            keystrokeToArray: function (a, b) {
                var c = b & 16711680, e = b & 65535, g = CKEDITOR.env.mac, m = [], d = [];
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, e, g = 0; g < b.length; g++) if (c = b[g].split("\x3d"), e = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), e === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    ...
                    for (c = 0; c < a.length; c++) var e = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36), b = b + (.5 < Math.random() ? e.toUpperCase() : e);
                    a = b;
            ...
            normalizeMouseButton: function (a, b) {
                ...
                for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE, 4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], e = 0; e < c.length; e++) {
                    var g = c[e];
            ...
            convertBytesToBase64: function (a) {
                var b =
                    "", c = a.length, e;
                for (e = 0; e < c; e += 3) {
                    var g = a.slice(e, e + 3), m = g.length, d = [], l;
            ...
            array: {
                filter: function (a, b, c) {
                    ...
                    for (var e = [], g = 0; g < a.length; g++) e.push(b.call(c, a[g], g, a));
                    return e
                }, reduce: function (a, b, c, e) {
                    for (var g = 0; g < a.length; g++) c = b.call(e, c, a[g], g, a);
                    return c
                    ...
                    for (var e = 0; e < a.length; e++) if (b.call(c, a[e], e, a)) return !0;
                    return !1
                }, zip: function (a, b) {
            ...
            object: {
                ...
                keys: function (a) {
                    var b = Object.prototype.hasOwnProperty, c = [], e = CKEDITOR.tools.object.DONT_ENUMS;
                    ...
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) for (g = 0; g < e.length; g++) b.call(a, e[g]) && c.push(e[g]);
                    return c
                },
                ...
                merge: function (a, b) {
                    var c = CKEDITOR.tools, e = c.clone(a), g = c.clone(b);
                    c.array.forEach(c.object.keys(g), function (a) {
                        e[a] = "object" === typeof g[a] && "object" === typeof e[a] ? c.object.merge(e[a], g[a]) : g[a]
                    });
                    return e
                }
            },
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), h = e.$.documentElement,
                        u = h.clientTop || d.$.clientTop || 0, m = h.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                } else for (u = this, m = null; u && "body" != u.getName() &&
                "html" != u.getName();) {
                ...
                w = a.getWindow();
                d = u(this, w);
                var y = u(a, w), G = this.$.offsetHeight;
                e = this.$.offsetWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, z = c.endOffset, h, g = this.guard, n = this.type,
    ...
    (function () {
        ...
        function d(a, b, c, d, f) {
            ...
            function m() {
                ...
                for (a = 0; a < e; a++) if (b = S[a], c = t[a], !b.equals(c)) return a;
                return a - 1
            }

            function g() {
                var b = P - 1, c = D && r && !n.equals(C);
            ...
            b = l || v;
            var n = a.startContainer, C = a.endContainer,
                L = a.startOffset, B = a.endOffset, N, q, D, r, x, T;
            if (l && C.type == CKEDITOR.NODE_TEXT && (n.equals(C) || n.type === CKEDITOR.NODE_ELEMENT && n.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, B))); else {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var c = this.startContainer, d = this.endContainer, f = this.collapsed, h, m, g, k;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var m = this.getCommonAncestor(), g = this.root, k, v, l, n, C, L = !1, B, N;
                        ...
                        for (l = c(l); l || n;) {
                            ...
                            for (; n;) if (B = !1, n.type == CKEDITOR.NODE_COMMENT) n = n.getPrevious(); else {
                                if (n.type == CKEDITOR.NODE_TEXT) N = n.getText(), d.test(N) && (n = null), B = /[\s\ufeff]$/.test(N); else if ((n.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && n.is("br")) && !n.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                    N = n.getText();
                                    if (d.test(N)) n = null; else for (var q = n.$.getElementsByTagName("*"), D = 0, r; r = q[D++];) if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) {
                                        n = null;
                                        break
                                    }
                                    n && (B = !!N.length)
                        ...
                        for (; l || n;) {
                            ...
                            for (; n;) {
                                B = !1;
                                if (n.type == CKEDITOR.NODE_TEXT) N = n.getText(), h(n, 0) || (n = null), B = /^[\s\ufeff]/.test(N); else if (n.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < n.$.offsetWidth || b && n.is("br")) && !n.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                        N = n.getText();
                                        if (d.test(N)) n =
                                            null; else for (q = n.$.getElementsByTagName("*"), D = 0; r = q[D++];) if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) {
                                            n = null;
                                            break
                                        }
                                        n && (B = !!N.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        x = x || g;
                        this.setStartAt(x,
                            !x.is("br") && (!l && this.checkStartOfBlock() || l && x.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var I = CKEDITOR.dom.walker.whitespaces(), p = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var h = new CKEDITOR.dom.walker(h), n = CKEDITOR.dom.walker.bookmark(),
            ...
            moveToElementEditEnd: function (a) {
                ...
                if (c && c.find) for (m = c.find(a), h = 0; h < m.count(); h++) if (c = m.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = u.startPath();
                    var m = u.endPath(), M = !u.collapsed && c(u, k.block), y = !u.collapsed && c(u, m.block, 1);
                ...
                for (this._.nextNode = null; m;) {
                    var M = 0, y = m.hasAscendant("pre"), G = m.type != CKEDITOR.NODE_ELEMENT, H = 0;
                    if (G) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (G = 0); else {
                        var n = m.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == m.getAttribute("contenteditable")) {
                            ...
                            if ("br" == n) G = 1; else if (!k && !m.getChildCount() && "hr" != n) {
                                d = m;
                                w = m.equals(u);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, f) {
            ...
            for (e in b) {
                ...
                for (q in T) {
                    p[q] = k(p[q], m) || null;
                    var r = p, t = S[q], h = k(p[S[q]], m), g = p[q], x = [], J = !0, P = void 0;
                    h ? J = !1 : h = {};
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, e = !0 === a, n = b.length; n--;) if (e || a(b[n])) b.splice(n, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function e(a) {
            var b, c, d, f, e = {}, n = 1;
            for (a = r(a); b = a.match(t);) (c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + n++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: f
        ...
        function A(a, b, f, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var r = 0, h = t.length, g; r < h; ++r) if (g = t[r](b)) {
                        t = g;
                        break a
                    }
                    t = void 0
            ...
            if (e.doFilter) {
                a:{
                    r = b.name;
                    h = a._;
                    a = h.allowedRules.elements[r];
                    t = h.allowedRules.generic;
                    r = h.disallowedRules.elements[r];
                    ...
                    if (a || t) {
                        w(b);
                        if (r) for (x = 0, D = r.length; x < D; ++x) if (!1 === c(r[x], b, k)) {
                            a = null;
                            break a
                        }
                        if (h) for (x = 0, D = h.length; x < D; ++x) c(h[x], b, k);
                        if (a) for (x = 0, D = a.length; x < D; ++x) d(a[x], b, k, g);
                ...
                var P = a.validStyles;
                t = a.validClasses;
                var r = b.attributes, J = b.styles, h = b.classes;
                g = b.classBackup;
                var C = b.styleBackup, B, L, l = [], k = [], N = /^data-cke-/;
                x = !1;
                delete r.style;
                delete r["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (B in r) D[B] || (N.test(B) ? B == (L = B.replace(/^data-cke-saved-/, "")) || D[L] || (delete r[B], x = !0) : (delete r[B], x = !0));
        ...
        function H(a, b, c) {
            var d = a.name;
            if (q.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (q.$block[d] || "tr" == d) if ("br" == b) a.previous && !G(a.previous) && (b = y(), b.insertBefore(a)), a.next && !G(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, f;
                b:{
                    f = q[b];
                    for (var e = 0, n = d.length, p; e < n; ++e) if (p = d[e], p.type == CKEDITOR.NODE_ELEMENT && !f[p.name]) {
                        f = !1;
                        break b
                    }
                    f = !0
                ...
                if (f) a.name = b, a.attributes =
                    ...
                    f = a.parent;
                    for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, r, m, n = d.length; 0 < n;) p = d[--n], e && (p.type == CKEDITOR.NODE_TEXT || p.type == CKEDITOR.NODE_ELEMENT && q.$inline[p.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
                        check: "parent-down",
                        el: r
                    })), r.add(p, 0)) : (r = null, m = q[f.name] || q.span, p.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || p.type != CKEDITOR.NODE_ELEMENT || m[p.name] || c.push({
                        check: "el-up",
                        el: p
                    }));
                    a.remove()
        ...
        function C(a, b) {
            var c = b.getDefinition(), d = c.attributes, f = c.styles, e, n, p, r;
            if (a.name != c.element) return !1;
            for (e in d) if ("class" == e) for (c = d[e].split(/\s+/), p = a.classes.join("|"); r = c.pop();) {
                if (-1 == p.indexOf(r)) return !1
            } else if (a.attributes[e] != d[e]) return !1;
            for (n in f) if (a.styles[n] !=
                f[n]) return !1;
            return !0
        }
        ...
        var q = CKEDITOR.dtd, D = CKEDITOR.tools.copy, r = CKEDITOR.tools.trim, x = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var f = this, e = [], n = this.editor && this.editor.config.protectedSource, p, r = !1,
                    t = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (p = A(f, a, e, t), p & 1) r = !0; else if (p & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var m, h, q;
                            if (n) for (h = 0; h < n.length; ++h) if ((q = d.match(n[h])) && q[0].length == d.length) {
                                c =
                                    !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (m = d.children[0]).type == CKEDITOR.NODE_ELEMENT && A(f, m, c, t);
                            c = !c.length
                        }
                        c || e.push(a)
                    }
                ...
                for (; h = a.pop();) if (c = h.el, c.parent) switch (g = q[c.parent.name] || q.span, h.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        b = a[f];
                        var e = void 0, n = void 0, p = void 0, r = void 0, m = void 0, h = void 0;
                        c = [];
                        for (n = 0; n < b.length; ++n) p = b[n], "string" == typeof p ? (p = p.split(/\s*:\s*/), r = p[0], m = null, h = p[1]) : (r = p.check, m = p.left, h = p.right), e || (e = p, e = e.element ? e.element : r ? r.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), m instanceof CKEDITOR.style && (m = B(m)), c.push({
                            check: r == e ? null : r,
                            left: m,
                ...
                } else f = a.getDefinition(), r = f.styles, d = f.attributes || {}, r && !CKEDITOR.tools.isEmpty(r) ? (r = D(r), d.style = CKEDITOR.tools.writeCssText(r, !0)) : r = {}, f = {
                    name: f.element,
                    attributes: d,
                ...
                var r = CKEDITOR.tools.clone(f), m = [], h;
        ...
        var T = {styles: 1, attributes: 1, classes: 1},
            ...
            P = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, I = /^cke:(object|embed|param)$/,
            p = /^(object|embed|param)$/, J;
        J = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, f = c.attributes, e, n, p, r;
                    a.name = c.element;
                    for (e in f) if ("class" ==
                        e) for (c = a.classes.join("|"), p = f[e].split(/\s+/); r = p.pop();) -1 == c.indexOf(r) && a.classes.push(r); else a.attributes[e] = f[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, h) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var g = b.length, l = g, v = [], e = [], z = function (a) {
                    c && (k ? c.call(f, a) : c.call(f, v, e))
                };
                if (0 === l) z(!0); else {
                    var w = function (a, b) {
                        (b ? v : e).push(a);
                        ...
                        if (a[b]) w(b, !0); else {
                            ...
                            if (!(1 < f.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function () {
                                    if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, A(b, !0)
                                } : (e.$.onload = function () {
                                    setTimeout(function () {
                                        e.$.onload = null;
                                        e.$.onerror = null;
        ...
        add: function (a, d) {
            ...
            CKEDITOR.scriptLoader.load(h,
                function (a, f) {
                    ...
                    for (var e = 0; e < a.length; e++) for (var h = k[a[e]], l = 0; l < h.length; l++) {
                        var m = h[l];
                        g[m] = this.get(m);
                        c[m] = 1
                    }
        ...
        return function (b, c, f) {
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], e;
                    for (e in a) {
                        var g = a[e], w = g && g.requires;
                        if (!d[e]) {
                            if (g.icons) for (var A = g.icons.split(","), F = A.length; F--;) CKEDITOR.skin.addIcon(A[F], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + A[F] + ".png");
    ...
    (function () {
        ...
        function z(a) {
            ...
            CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    ...
                    for (var n in b) {
                        var h = b[n], k = h.lang, C = null, t = h.requires, P;
                        CKEDITOR.tools.isArray(t) && (t = t.join(","));
                        if (t && (P = t.match(g))) for (; t = P.pop();) CKEDITOR.error("editor-plugin-required", {
                            plugin: t.replace(",", ""),
                            requiredBy: n
                        });
                    ...
                    CKEDITOR.scriptLoader.load(e, function () {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], e = 0; e < b.length; e++) for (var n = 0; n < d.length; n++) {
                                var r = d[n];
        ...
        function A(a, b) {
            ...
            for (var f = new CKEDITOR.dom.documentFragment, e, h, g, k = 0; k < a.length; k++) {
                var l = a[k], q = l.startContainer.getAscendant("tr", !0);
                c(l) ? (e || (e = q.getAscendant("table").clone(), e.append(q.getAscendant({
                        thead: 1,
                        tbody: 1,
                        tfoot: 1
                    }).clone()), f.append(e), e = e.findOne("thead, tbody, tfoot")), h && h.equals(q) || (h = q, g = q.clone(), e.append(g)), g.append(d(l))) :
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            plugins: {
                ...
                if (c) {
                    var f = CKEDITOR.tools.object.findKey(this.commands, c), e = this.keystrokeHandler.keystrokes;
                    if (c.fakeKeystroke) d.push(c.fakeKeystroke); else for (var h in e) e[h] === f && d.push(h)
                }
                return b ? d : d[0] || null
            }, addFeature: function (a) {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (h, k, g) {
                ...
                var F = new CKEDITOR.htmlParser,
                    ...
                    m = [], M = [], y = u, G = "textarea" == u.name, H = "pre" == u.name;
                    ...
                    if (a(e)) m.push(e); else {
                        ...
                        if ("br" == f) M.push(e); else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || y.isUnknown || g[f]);) if (y.isOptionalClose) F.onTagClose(h); else if (f in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || z(h = new CKEDITOR.htmlParser.element("li"), y), !e.returnPoint && (e.returnPoint = y), y = h; else if (f in CKEDITOR.dtd.$listItem &&
                                !A(f, h)) F.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !A(f, h)) !e.returnPoint && (e.returnPoint = y), y = y.parent; else if (h in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) z(y, y.parent, 1); else {
                                e.isOrphan = 1;
                                break
                            }
                            l(f);
                ...
                F.onText = function (a) {
                    ...
                    if (!G && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a); else {
                        v();
                        l();
                        H || G || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    h = Array.prototype.slice.call(arguments, 1), k = this.rules, g = k.length, l, v, e, z;
                for (z = 0; z < g; z++) if (d && (l = c.type, v = c.name), e = k[z], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function r(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var p = [], r = b(f), n, q;
                        if (r) for (t(r, 1) && p.push(r); r;) h(r) && (n = c(r)) && t(n) && ((q = c(n)) && !h(q) ? p.push(n) : (e(g).insertAfter(n), n.remove())), r = r.previous;
            ...
            var q = {elements: {}}, g = "html" == d, x = CKEDITOR.tools.extend({}, n), D;
            ...
            return a.replace(q,
                function (a, b, c) {
                    return "\x3c" + b + c.replace(D, function (a, b) {
                        return r.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a
                    }) + "\x3e"
                })
        }
        ...
        function u(a, b) {
            ...
            for (var r = 0; r < d.length; r++) a = a.replace(d[r], function (a) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, f) {
                return "\x3c" + c + d + "\x3e" + F(A(f), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, f, c = m(c), c = u(c, b), c = e(c, T), c = v(c), c = e(c, x),
                    c = c.replace(t, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
            ...
            b.on("toHtml", function (a) {
                a.data.dataValue.filterChildren(r.dataFilter, !0)
            }, null, null, 10);
            b.on("toHtml", function (a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function (a) {
                a.data.dataValue.filterChildren(r.htmlFilter, !0)
            }, null, null, 10);
            b.on("toDataFormat", function (a) {
            ...
            b.on("toDataFormat", function (a) {
                var c = a.data.dataValue, d = r.writer;
                d.reset();
        ...
        var M = /(?:&nbsp;|\xa0)$/, y = "{cke_protected}", G = CKEDITOR.dtd,
            H = "caption colgroup col thead tfoot tbody".split(" "), n = CKEDITOR.tools.extend({}, G.$blockLimit,
            G.$block), C = {elements: {input: g, textarea: g}}, L = {
                ...
                elements: {
                    ...
                    table: function (a) {
                        a.children.slice(0).sort(function (a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(H, a.name), d = CKEDITOR.tools.indexOf(H, b.name));
        ...
        var q = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            P = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        m = function () {
            function a(c) {
                return CKEDITOR.tools.array.reduce(c.split(""), function (a, c) {
                    var d = c.toLowerCase(), f = c.toUpperCase(), e = b(d);
                    d !== f && (e += "|" + b(f));
                    return a + ("(" + e + ")")
                }, "")
            }
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a,
                d, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count(); f < h; f++) a = c.getItem(f), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = {
                element: a,
                config: {}
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, q = g.getRanges()[0], h;
            ...
            !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = q.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && q.select()
        }
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
                        ...
                        thead: 1,
                        tfoot: 1
                    }) ? M(b) : b.startContainer.is(CKEDITOR.dtd.$list) && y(b));
                    var g, r;
                    if (f) for (; (g = b.getCommonAncestor(0, 1)) && (r = CKEDITOR.dtd[g.getName()]) && (!r || !r[e]);) if (g.getName() in
                        CKEDITOR.dtd.span) {
                ...
                fixInitialSelection: function () {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var g = f.getHead(), q = g.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in D) {
                                    var e, f = b.getRanges()[0], q = f.startPath(), g, p, k, c = 8 == c;
                                    CKEDITOR.env.ie &&
        ...
        m = function () {
            ...
            function b(c, d) {
                var e, f, q, g, h = [], k = d.range.startContainer;
                e = d.range.startPath();
                for (var k = r[k.getName()], D = 0, x = c.getChildren(), l = x.count(), m = -1, B = -1, v = 0, T = e.contains(r.$list); D <
                l; ++D) e = x.getItem(D), a(e) ? (q = e.getName(), T && q in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (g = !!k[q], "br" != q || !e.data("cke-eol") || D && D != l - 1 || (v = (f = D ? h[D - 1].node : x.getItem(D + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && r.$block[f.getName()]), -1 != m || g || (m = D), g || (B = D), h.push({
                    isElement: 1,
                    isLineBreak: v,
                ...
                -1 < B && (h[B].lastNotAllowed = 1);
                return h
            }

            function d(b, c) {
                var e = [],
                    f = b.getChildren(), q = f.count(), g, h = 0, k = r[c], D = !b.is(r.$inline) || b.is("br");
            ...
            var r = CKEDITOR.dtd, x = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, m = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, v = CKEDITOR.tools.extend({}, r.$inline);
            delete v.br;
            return function (t, x, I, p) {
                ...
                if (!p.checkReadOnly()) {
                    ...
                    var E = x.range, w = x.mergeCandidates, K = "html" === x.type, u, z, A, y, F, V;
                    "text" == x.type &&
                    ...
                    for (; (F = e(E)) && a(F) && F.isBlockBoundary() && A.contains(F);) E.moveToPosition(F,
                    ...
                    for (u = z.startNode; (u = u.getParent()) && f(u);) w.push(u);
                    E.moveToBookmark(z);
                    ...
                    if (t = I) {
                        ...
                        I = x.editor.dataProcessor.toHtml(I,
                            {
                                context: null,
                                fixForBody: !1,
                                protectedWhitespaces: !!W,
                                dontFilter: x.dontFilter,
                                filter: x.editor.activeFilter,
                                enterMode: x.editor.activeEnterMode
                            });
                        ...
                        if ((W = t.startPath().block) && (1 != W.getChildCount() || !W.getBogus())) a:{
                            ...
                            if (1 == p.getChildCount() && a(Q = p.getFirst()) && Q.is(m) && !Q.hasAttribute("contenteditable")) {
                                ...
                                t = 0;
                                for (V = W.count(); t < V; t++) if (J = W.getItem(t), !J.is(v)) break a;
                    ...
                    if (t) {
                        ...
                        for (h(J, Q); V < J.length; V++) {
                            E = J[V];
                            if (K = E.isLineBreak) K = Q, u = p, y = A = void 0, E.hasBlockSibling ? K = 1 : (A = K.startContainer.getAscendant(r.$block, 1)) && A.is({
                                div: 1,
                                p: 1
                            }) ? (y = A.getPosition(u), y ==
                            ...
                            if (K) I = 0 < V; else {
                                ...
                                if (z && E.isElement) {
                                    ...
                                    if (K) u && (H = Q.splitElement(u), x.zombies.push(H), x.zombies.push(u)); else {
                                        u = p.getName();
                                        M = !V;
                                        K = V == J.length - 1;
                                        u = d(E.node, u);
                    ...
                    if (M) for (; O = M.pop();) CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(R.document.createText(" "));
                ...
                list: {
                        ...
                        g.guard = function (a,
                            ...
                            if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && t && a.equals(t)) f = c.clone(), f.setStartAt(t, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                                ...
                                if (!l && (l = g)) if (a.is(d)) var l = h && h.getAscendant("table", !0),
                                    m = t && t.getAscendant("table", !0), n = a.getAscendant("table",
                                        !0), l = l && l.contains(n) || m && m.contains(n); else l = void 0;
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), h = g.clone(), k, t, l = g.getCommonAncestor();
    ...
    (function () {
        ...
        function w(a, b) {
            return b ? a.replace(G, function (a, b) {
                return b ? " " : ""
            }) : a.replace(y, "")
        }
        ...
        var m = "function" != typeof window.getSelection, M = 1, y = CKEDITOR.tools.repeat("​", 7),
            G = new RegExp(y + "( )?", "g"), H, n, C, L = CKEDITOR.dom.walker.invisible(1), B = function () {
                function a(b) {
                    return function (a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var f = c.document, g = CKEDITOR.document, p = c.editable(), l = f.getBody(),
                    q = f.getDocumentElement(), D = p.isInline(),
                    n, v;
                ...
                if (CKEDITOR.env.ie && !D) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) q.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (g.on("mouseup", b), q.on("mouseup", b))
                        })
                    }
                }
            ...
            getNative: function () {
                ...
                var a = m ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, m = -1, q, r; k <= l;) if (m = Math.floor((k + l) / 2), f = e[m], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = m - 1; else if (0 > q) k = m + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        ...
                        for (; 0 < h;) try {
                            g = f[0 < q ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, r = g), f = g
                        } catch (n) {
                    ...
                    if (t) this.fake(t); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !H && !a[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                        if (m) {
                            ...
                            for (E = 0; E < a.length; E++) {
                                ...
                                try {
                                    n.setEnd(b.endContainer.$, b.endOffset)
                                } catch (w) {
                                    if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), n.setEnd(b.endContainer.$, b.endOffset); else throw w;
                                }
                                k.addRange(n)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var v = c.createBookmark(), u = v.startNode, w = v.endNode, q = u, z;
                if (!l) {
                    var x = c.getCommonAncestor(), l = a(u, x), x = a(w, x);
                    l && (q = l.getNextSourceNode(!0));
                    x && (w = x)
                }
                for (q.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    l = !1;
                    if (q.equals(w)) q = null, l = !0; else {
                        ...
                        if (A && q.data("cke-bookmark") || q.type === CKEDITOR.NODE_COMMENT) {
                            q = q.getNextSourceNode(!0);
                            continue
                        }
                        if (x && m && CKEDITOR.dtd.$block[A]) for (var B = q, C = f(B), D = void 0, G = C.length, H = 0, B = G && new CKEDITOR.dom.range(B.getDocument()); H < G; ++H) {
                            var D = C[H], L = CKEDITOR.filter.instances[D.data("cke-filter")];
                            if (L ? L.check(this) : 1) B.selectNodeContents(D), b.call(this, B)
                        }
                        C = A ? !n[A] || y ? 0 : x && !m ? 0 : d(q, w, h, T) : 1;
                        if (C) if (D =
                            q.getParent(), C = h, G = g, H = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[G] && !H || C.parentRule && !C.parentRule(D)) l = !0; else {
                            if (z || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(w) | T) != T || (z = c.clone(), z.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                for (var A = q, N; (l = !A.getNext(r)) && (N = A.getParent(), n[N.getName()]) && d(N, u, h, S);) A = N;
                                z.setEndAfter(A)
                            }
                        } else l = !0;
                    ...
                    if (l && z && !z.collapsed) {
                        for (var l = M(this, e), x = l.hasAttributes(), y = z.getCommonAncestor(),
                                 A = {}, C = {}, D = {}, G = {}, Y, X, Z; l && y;) {
                            if (y.getName() == g) {
                                for (Y in h.attributes) !G[Y] && (Z = y.getAttribute(X)) && (l.getAttribute(Y) == Z ? C[Y] = 1 : G[Y] = 1);
                                for (X in h.styles) !D[X] && (Z = y.getStyle(X)) && (l.getStyle(X) == Z ? A[X] = 1 : D[X] = 1)
                            }
                            y = y.getParent()
                        }
        ...
        var B = {
                ...
                audio: 1,
                video: 1
            }, q = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, r = CKEDITOR.dom.walker.bookmark(0, 1),
